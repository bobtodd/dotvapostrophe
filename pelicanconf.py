...
#
# If you use that method, comment-in the following code:
#
...
#
# But if you used the method of adding this to base.html,
#
# {% if 'liquid_tags.notebook' in PLUGINS %}
#     {% include '_includes/liquid_tags_nb_header.html' %}
# {% endif %}
#
# ... then leave the preceding code commented-out.
